...
/// @author   Erik ZORZIN
/// @date     24OCT2019
/// @brief    Definition of the "opengl" class.
...
)
{
  ...
  (
   ...
   framebuffer_size_x                                                                                // Window x-size [px].
  );
  ...
  (
   ...
   framebuffer_size_y                                                                                // Window y-size [px].
  );
...
)
{
  switch(PR_mode)
  {
    case NU_MODE_MONO:
      ...
      set_shader (loc_shader, V_mat, P_mat, framebuffer_size_x, framebuffer_size_y, aspect_ratio);   // Setting plot style...
    ...
    case NU_MODE_STEREO:
      ...
      // Left eye:
      set_shader (loc_shader, VL_mat, PL_mat, framebuffer_size_x, framebuffer_size_y, aspect_ratio); // Setting plot style...
      ...
      // Right eye:
      set_shader (loc_shader, VR_mat, PR_mat, framebuffer_size_x, framebuffer_size_y, aspect_ratio); // Setting plot style...
